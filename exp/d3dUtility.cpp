	...
	IDirect3DDevice9** device)
{
	...
	HWND hwnd = 0;
	hwnd = ::CreateWindow("DxTest", "DxTest", 
		WS_EX_TOPMOST,
		0, 0, width, height,
...
{
	// infinite small 
	_min.x = d3d::INFINITYMAX;
	_min.y = d3d::INFINITYMAX;
	_min.z = d3d::INFINITYMAX;

	_max.x = -d3d::INFINITYMAX;
	_max.y = -d3d::INFINITYMAX;
	_max.z = -d3d::INFINITYMAX;
}
